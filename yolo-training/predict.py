...
CLASS_MAPPINGS = {
    ...
    "biriyani": {"foodId": "khichuri", "label": "Biryani (Rich Spiced Rice)"},
    ...
    "egg": {"foodId": "chicken", "label": "Dim (Egg Curry)"},
    "egg-boiled": {"foodId": "chicken", "label": "Boiled Egg"},
    "egg-poached": {"foodId": "chicken", "label": "Poached Egg"},

    # Vegetables & Bhortas (Begun Bhaja, Aloo Bhorta)
    "begun-vaji": {"foodId": "begun_bhaja", "label": "Begun Bhaja (Fried Eggplant)"},
    "beguni": {"foodId": "begun_bhaja", "label": "Beguni (Fried Eggplant in Batter)"},
    ...
    "chop-alu": {"foodId": "singara", "label": "Alur Chop (Potato Snack)"},
    "lal-shak": {"foodId": "begun_bhaja", "label": "Lal Shak (Red Spinach)"},
    "shak": {"foodId": "begun_bhaja", "label": "Shak (Spinach/Greens)"},
    "vaji": {"foodId": "begun_bhaja", "label": "Vaji (Stir-fried Vegetables)"},
    "vegetable": {"foodId": "begun_bhaja", "label": "Mixed Vegetables"},
    "cabbage": {"foodId": "begun_bhaja", "label": "Cabbage Vaji"},
    "carrot": {"foodId": "begun_bhaja", "label": "Carrot (Gajor)"},
    ...
    "tomato": {"foodId": "begun_bhaja", "label": "Tomato"},
    "cucumber": {"foodId": "begun_bhaja", "label": "Shosha (Cucumber)"},
    "salad": {"foodId": "begun_bhaja", "label": "Salad (Cucumber & Onion)"},
    ...
    "chola": {"foodId": "fuchka", "label": "Chola Boot (Chickpeas)"},
    "peyaju": {"foodId": "singara", "label": "Peyaju (Onion Lentil Fritter)"},
    "piyaju": {"foodId": "singara", "label": "Peyaju (Onion Lentil Fritter)"},
    ...
    "watermelon": {"foodId": "begun_bhaja", "label": "Watermelon (Tormuj)"},
    ...
    "juice": {"foodId": "roshogolla", "label": "Fruit Juice"},
